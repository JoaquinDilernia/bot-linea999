...
const COLLECTION = 'bot-nuevaaurora_agents';
...
const ADMIN_SEEDS = [
  { email: process.env.ADMIN_EMAIL || 'admin@nuevaaurora.com.ar', name: process.env.ADMIN_NAME || 'Admin', password: process.env.ADMIN_PASSWORD },
];
