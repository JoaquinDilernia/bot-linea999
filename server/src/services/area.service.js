...
const COLLECTION = 'bot-nuevaaurora_areas';
const AGENTS_COLLECTION = 'bot-nuevaaurora_agents';

const SEED_AREAS = [
  {
    id: 'pasajes',
    name: 'Consultas y Pasajes',
    description: 'Consultas sobre horarios, recorridos, tarifas, o compra de pasajes del servicio interurbano que el bot no pudo resolver solo con la información cargada.',
    active: true,
    order: 1,
  },
  {
    id: 'reclamos',
    name: 'Reclamos y Objetos Perdidos',
    description: 'Quejas por demoras, mal trato o incidentes en el servicio, y consultas por objetos olvidados en alguna unidad.',
    active: true,
    order: 2,
  },
];
