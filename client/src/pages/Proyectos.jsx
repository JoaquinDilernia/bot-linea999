    ...
    <div className={styles.page}>
      <div className={styles.header}>
        <div>
          ...
          <p className={styles.subtitle}>Clientes y proyectos — vinculá los contactos de WhatsApp de cada uno para que el bot arme tickets con el proyecto correcto.</p>
        </div>
        {canEdit && !editing && (
        ...
        <div className={styles.editCard}>
          ...
          <div className={styles.formRow}>
            <label className={styles.field}>
              ...
              <input value={editing.nombre} onChange={e => setEditing({ ...editing, nombre: e.target.value })} placeholder="Ej: Bot Nueva Aurora" />
            </label>
            <label className={styles.field}>
              <span>Empresa</span>
