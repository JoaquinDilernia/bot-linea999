...
const COLLAPSED_KEY = 'na_sidebar_collapsed';
...
const NAV_ITEMS = [
  ...
  { to: '/tarifario',     label: 'Tarifario',       icon: IconDollar,     minRole: 'atencion_cliente' },
  { to: '/reclamos',      label: 'Reclamos',        icon: IconTicket },
  ...
  return (
    <div className={styles.shell}>
      ...
      <header className={styles.mobileHeader}>
        ...
        <span className={styles.mobileBrand}>Nueva Aurora</span>
      </header>
      ...
      <aside className={`${styles.sidebar} ${menuOpen ? styles.sidebarOpen : ''} ${collapsed ? styles.sidebarCollapsed : ''}`}>
        <div className={styles.brand}>
          ...
          <div className={styles.brandText}>
            <span className={styles.brandName}>Nueva Aurora</span>
